...
Виклав код у вільний доступ аби бажаючі могли під себе налаштувати швиденько. Але наразі проект сирий, його треба і тестити, і доводити до розуму. 

Мета створення коду проста:

а) отримувати інформацію про оновлення графіків відключень електроенергії з декількох джерел одночасно;

б) виводити цю інформацію на власному Телеграм-каналі у зручному для мене текстовому вигляді.

У мене немає ані часу, ані бажання, ані знань та навичок, щоб підтримувати та розвивати цей код. Зміні до коду вноситимуться хаотично та спонтанно. Хочете долучитись - краще зробіть форк чи напишіть власний код.
 
Якщо у Вас виникне бажання розібратись у роботі кода абощо, поставити питання до цього репозиторію можна тут (ШІ):
...
Якщо вам просто треба відстежувати оновлення графіків, ось кілька готових рішень для Телеграм:
1. Скористайтесь готовими ботами:
   
   [Ясно Зрозуміло](https://t.me/yasnozrozumilobot)

   [ДТЕК Київські електромережі](https://t.me/DTEKKyivskielectromerezhibot)

2. Підпишіться на канали (не реклама, просто те, чим сам користуюсь):
   
   [Світло Київ та Київщина | Графіки | Аварійка | Вмикач | Єсвітло](https://t.me/kyivsvitlo_dtek)

   [Напруга Є](https://t.me/DTEKinfo)

   [єСвітло💡Київ | Світло](https://t.me/esvitlo_kyiv_ua)
   
3. Знайдіть канал світлоБота для своєї групи (раджу подивитися декілька, для різних будинків з однієї черги, бо якість контенту може відрізнятись). Для пошуку таких каналів зручно використовувати мапи з розділу "Корисне"

Не забувайте вчасно коригувати номери черг! Інколи будинки переносять до інших груп без попереджень!
...
Про всяк випадок вимкніть у sources "yasno" ("enabled": false), залишивши лише "github". Я знайшов у yasno інфу лише для міст Київ та Дніпро, через що можуть виникати конфлікти.
...
Налаштування для регіонів я не тестив ...
...
[Отримати номер групи для Києва](https://banditbyte.github.io/light-monitor-kyiv/group_detector.html)
...
[Мапа з часовою шкалою знімків](https://power.area.pp.ua/)
